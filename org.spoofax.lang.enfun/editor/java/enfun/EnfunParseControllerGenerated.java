...
public class EnfunParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Enfun");
  ...
  { 
    EnfunParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EnfunParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EnfunParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EnfunParseControllerGenerated.class);
    }
  ...
  { 
    return EnfunParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
